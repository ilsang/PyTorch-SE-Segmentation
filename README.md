...
# Semantic Segmentation with SE block in PyTorch
...
Denseblock is key component of Densenet and is dependent on growth rate. Details of denseblock are illustrated by [The One Hundred Layers Tiramisu: Fully Convolutional DenseNets for Semantic Segmentation](https://arxiv.org/abs/1611.09326)

<img src='img/densenet_archi.png' width="300px"/>

SE-Densenet is constructed by stacking SE-denseblocks and they are generated by adding SE block to original denseblock.
